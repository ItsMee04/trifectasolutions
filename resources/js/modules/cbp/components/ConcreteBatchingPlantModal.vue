<template>
    <div class="modal fade" id="modalCBP" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formCBP.tanggal" type="date" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formCBP.material_id" :options="materialList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formCBP.kendaraan_id" :options="kendaraanList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <Multiselect v-model="formCBP.driver_id" :options="driverList"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formCBP.jarakawal" type="text" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formCBP.jarakakhir" type="text" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formCBP.jarak" type="number" step="0.01" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formCBP.beratmuatan" type="text" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-group local-forms mb-3">
                                        ...
                                        <input v-model="formCBP.jenis" type="text" class="form-control"
