        ...
        <div class="card-body">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h5 class="card-title">Daftar Jarak & Harga</h5>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-nowrap table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr v-else-if="!paginatedJarakDanHarga || paginatedJarakDanHarga.length === 0">
            ...
            <div v-if="filteredJarakDanHarga.length > 0" class="d-flex justify-content-between align-items-center p-3">

                <div class="text-muted small">
                    Showing {{ ((currentPage - 1) * 10) + 1 }}
                    to {{ Math.min(currentPage * 10, filteredJarakDanHarga.length) }}
                    of {{ filteredJarakDanHarga.length }} entries
                </div>
